...
const FinanceApp: React.FC<{ summary?: boolean }> = ({ summary = false }) => {
    ...
    const handleItemUpdate = (id: string, totalStockToBuy: number) => {
        ...
        const itemToUpdate = stockToPurchase.findIndex(
            (stock) => stock.id === id
        )
            ...
            {status === 'idle' && (
                <>
                    <div className="summary-panels">
                        <InvestTotals
                            value={formatMoney(apiResult.overallTotalInEuro)}
                        />
                        <InvestTotals
                            title="Total + / -"
                            value={formatMoney(
                                apiResult.overallTotalInEuro -
                                    apiResult.overBETotalInEuro
                            )}
                        />
                    ...
                    {!summary && (
                        <>
                            <InvestmentsChart
                                portfolioItems={apiResult.portfolioItems}
                            />
